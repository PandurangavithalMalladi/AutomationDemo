...
public class HomePage {
	...
	public void ClickOnUserRole() throws InterruptedException {
		...
		WebElement dropdown = wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//label[contains(text(),'User Role')]/following::div[1]")));
		dropdown.click();

		// Wait for dropdown options to appear and select "Admin"
		WebElement adminOption = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@role='option' and text()='Admin']")));
		adminOption.click();
